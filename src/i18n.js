...
const T = {
  uk: {
    ...
    tabShop: 'Магазин',
    soonCar: 'Машина й цех — на наступних етапах',
    btnTie: 'Зав\'язати',
    ...
    upNames: { pump2: 'Насос II', sign: 'Вивіска', confetti: 'Кульки з конфеті', foil: 'Фольга: серця й зірки', tank200: 'Балон 200', pump3: 'Насос III', online: 'Онлайн-замовлення', shop: 'Переїзд у магазин', digits: 'Фольговані цифри', helper: 'Другий продавець', ads: 'Реклама' },
    upDesc: { pump2: 'Надуває швидше', sign: 'Клієнтів +15%', confetti: 'Новий товар, 30 ₴', foil: 'Новий товар, 55 ₴', tank200: 'Гелію вдвічі більше', pump3: 'Надуває ще швидше', online: 'Доставка кур\'єром, +60 ₴', shop: 'Оренда 150 ₴, клієнти терплячіші', digits: 'Дні народження, цифра 100 ₴', helper: 'Сам обслуговує клієнтів, яким треба до 3 кульок. Зарплата 100 ₴/день', ads: 'Більше днів народження' },
  },
  ru: {
    title: 'MagicAir Tycoon',
    ...
    tabShop: 'Магазин',
    soonCar: 'Машина и цех — на следующих этапах',
    btnTie: 'Завязать',
    ...
    upNames: { pump2: 'Насос II', sign: 'Вывеска', confetti: 'Шары с конфетти', foil: 'Фольга: сердца и звёзды', tank200: 'Баллон 200', pump3: 'Насос III', online: 'Онлайн-заказы', shop: 'Переезд в магазин', digits: 'Фольгированные цифры', helper: 'Второй продавец', ads: 'Реклама' },
    upDesc: { pump2: 'Надувает быстрее', sign: 'Клиентов +15%', confetti: 'Новый товар, 30 ₴', foil: 'Новый товар, 55 ₴', tank200: 'Гелия вдвое больше', pump3: 'Надувает ещё быстрее', online: 'Доставка курьером, +60 ₴', shop: 'Аренда 150 ₴, клиенты терпеливее', digits: 'Дни рождения, цифра 100 ₴', helper: 'Сам обслуживает клиентов, которым нужно до 3 шаров. Зарплата 100 ₴/день', ads: 'Больше дней рождения' },
  },
};
