...
export const CONFIG = {
  ...
  // Надування: заповнення 0→1 за fullSec. [0, greenMin) — недодув, [greenMin, greenMax] — ідеально, вище — лопнула.
  // Насос швидший → зелена зона ширша, щоб «вікно» в секундах лишалось однаковим (≈0,4 с).
  pumps: [
    { fullSec: 1.8,  greenMax: 0.82 },   // насос I
    { fullSec: 1.44, greenMax: 0.875 },  // насос II
    { fullSec: 1.15, greenMax: 0.944 },  // насос III
  ],
  ...
  customers: {
    ...
    firstAtSec: 1.5,
    patienceSec: 35,    // скільки клієнт чекає (разом з чергою)
